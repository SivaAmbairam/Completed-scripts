...
if __name__ == '__main__':
    ...
    demo_df = pd.read_csv(r'C:\Users\G6\PycharmProjects\WebScrappingWebPage\Scrapping Scripts\Output\Product_Comparison_Manual_export.csv', encoding='latin1')
    flinn_df = pd.read_csv(r'C:\Users\G6\PycharmProjects\WebScrappingWebPage\Scrapping Scripts\Output\Flinn_Products.csv')
    frey_df = pd.read_csv(r'C:\Users\G6\PycharmProjects\WebScrappingWebPage\Scrapping Scripts\Output\Frey_products.csv')
    nasco_df = pd.read_csv(r'C:\Users\G6\PycharmProjects\WebScrappingWebPage\Scrapping Scripts\Output\Nasco_products.csv')
    carolina_df = pd.read_csv(r'C:\Users\G6\PycharmProjects\WebScrappingWebPage\Scrapping Scripts\Output\Carolina_Products.csv')
    vwr_df = pd.read_csv(r'C:\Users\G6\PycharmProjects\WebScrappingWebPage\Scrapping Scripts\Output\VWR_WARDS_Products.csv')
    fisher_df = pd.read_csv(r'C:\Users\G6\PycharmProjects\WebScrappingWebPage\Scrapping Scripts\Output\Fisher_products.csv')
    wardsci_df = pd.read_csv(r'C:\Users\G6\PycharmProjects\WebScrappingWebPage\Scrapping Scripts\Output\Wardsci_products.csv')
