...
if __name__ == '__main__':
    ...
    all_products = soup.find_all('div', class_='category_group list_group collapsible')[:15]
    '''PRODUCT_CATEGORY'''
            ...
            for single_url in content_url:
                ...
                if product_request.find('table', class_='general_table product_table responsive_product_table'):
                    ...
                    for single_content in other_content:
                        ...
                        articles_df.drop_duplicates(subset=['Fisher_product_id', 'Fisher_product_name'],
